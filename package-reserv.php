...
session_start();
    ...
    $all_packages_query = "select * from packages join users on packages.client_name = users.user_name where Full = 'true'";
    $all_packages = mysqli_query($con, $all_packages_query);
      ...
      <div class="row justify-content-center">
        <div class="col-xl-10 d-flex align-items-center justify-content-end">
          ...
          <ul>
              ...
              <li class="active"><a href="package-reserv.php">Packages Reservations</a></li>
    ...
    <section class="inner-page">
        <div class="container">
            <table class="table table-striped">
                ...
                <tbody>
                <?php
                    while($row = mysqli_fetch_array($all_packages)) {
                ?>
                    <tr>
